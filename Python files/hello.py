...
# Last_name="Narute"
# age=8
# friend_names=['Priya','Aaradhya','Arshida']
# print("%s-%s Welcome to lists."%(first_name,Last_name))
# print("You are %d years old.You can make lists easyly."%(age))
# print("And you have 3 friends mainly named %s,so you can make lists easyly."%(friend_names))